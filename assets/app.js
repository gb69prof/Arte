const galleries = [
  ...
  {roman:"III",title:"Rivoluzioni dello sguardo",years:"XIX secolo",color:"blue",thesis:"La storia sociale entra nell’immagine: il lavoro, la città, la percezione e il tempo instabile trasformano ciò che merita di essere rappresentato.",modules:[
...
const liveModules = {
  ...
  "14": { href: "PWA/14-impressionismo/index.html", label: "nuovo modulo" }
};
