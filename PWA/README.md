...
- [22 · Quando l’immagine diventa merce — Pop Art: consumo, pubblicità, ripetizione](./22-pop-art/)
- [23 · L’opera può scomparire — Arte concettuale e performance: idea, corpo, azione](./23-arte-concettuale-performance/)
...
Il modulo 21 apre la quinta galleria distinguendo fine militare, liberazione, sopravvivenza, ricostruzione, testimonianza, memoria pubblica, Guerra fredda e decolonizzazione. La fotografia Bundesarchiv di un pozzo della U-Bahn danneggiato nel 1945 apre e chiude tredici sezioni. Comparatore delle immagini, cronologia 1945–1964, classificatori etici, laboratori astratti su materia, gesto, colore e spazio, rete italiana, persistenza della figura, mappa policentrica, Gutai, circuito istituzionale, atlante e verifica di sedici nuclei mostrano che astrazione e figurazione non sono risposte morali automatiche. Le opere protette non sono copiate né imitate; la fotografia locale e i limiti sono documentati in `SOURCES.md`. Lo stato usa esclusivamente `storia-sguardo-21-state`; la soglia conduce ora direttamente al modulo 22.

Il modulo 22 legge la Pop Art come un campo di rapporti fra oggetti, riproduzioni, desiderio, lavoro e istituzioni. Tredici sezioni collegano Independent Group, Londra, New York, Italia e altri centri, distinguono Dada, Neo-Dada e Pop e ricostruiscono provenienza e trasformazioni delle fonti. La PWA comprende marcatori della fotografia iniziale, cronologia e rete, quattro laboratori su collage, serialità, oggetto e valore, comparatori, mappa policentrica, atlante e sintesi delle sole azioni. Le opere protette restano collegate a schede ufficiali; la fotografia ArkDes locale è in pubblico dominio. Stato e padronanza usano soltanto `storia-sguardo-22-state`; la verifica comprende sedici nuclei con spiegazioni, microlezioni e recuperi differenti, e la soglia conduce ora direttamente al modulo 23.

Il modulo 23 segue lo spostamento dall’oggetto stabile verso idea, istruzione, azione, corpo, durata, relazione e documento, senza descriverlo come sparizione letterale della materia. Il ritratto CC0 di John Cage apre un’osservazione sulle assenze e viene rivelato come documento d’archivio, non come opera. Tredici sezioni includono cronologia e rete, classificatore, laboratorio dell’istruzione, comparatori su evento e documentazione, durata e pubblico, lenti su corpo e consenso, catena di provenienza, mappa policentrica, rete italiana, simulatore di certificato, circuito istituzionale, atlante e sintesi delle sole azioni. Sedici nuclei con microlezioni e recuperi differenti richiedono padronanza completa. Stato e cache sono isolati con `storia-sguardo-23-state` e `storia-sguardo-23-v1`; la soglia prepara il modulo 24 senza crearne la cartella.
