...
Il modulo 14 sposta la domanda dal soggetto rappresentato alle condizioni temporali e sociali della percezione. Mantiene tredici sezioni, indice, avanzamento e tre taccuini con chiave `storia-sguardo-14-state`, lightbox accessibile, verifica con dodici concetti obbligatori e microlezioni di recupero, cache offline e reset locali. Introduce cronologia e rete causale non deterministica, laboratorio dell’istante in dieci parametri, analisi a livelli di *Impression, soleil levant*, laboratori su metropoli e stazione, attività su loisir e lavoro invisibile, confronto Morisot/Cassatt, serie sincronizzata dei covoni e atlante finale per venti categorie. La soglia conclusiva prepara il modulo 15 senza costruirlo.
