...
self.addEventListener("fetch", event => {
  ...
  if (url.origin !== self.location.origin || !url.pathname.includes("/PWA/23-arte-concettuale-performance/")) return;
